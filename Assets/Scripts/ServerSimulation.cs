...
public class ServerSimulation : ServerSimulator
{
    ...
    public bool ReceiveData(Data data,int trueId)
    {
        ...
        if(gameEvent==GameEvent.RemovePlayer)
    ...
    private bool RemovePlayer(byte id)
    {
        ...
        Data data = new Data(new DataHeader(id,GameEvent.RemovePlayer),playerCards);
        SendToAll(data);
    ...
    private bool SwapCards(byte id,CardStruct[] cards)
    {
        ...
        Data data = new Data(new DataHeader(id,GameEvent.SwapCards),cards);        
        SendToAll(data);
    ...
    private bool Ready(byte id)
    {
        ...
        Data data = new Data(new DataHeader(id,GameEvent.Ready));        
        SendToAll(data);
